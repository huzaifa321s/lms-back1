...
getLandingBlog: async (req, res) => {
  try {
    // Latest 6 blogs (ya jo count chahiye)
...
console.log('blogs',blogs)
    return SuccessHandler({ blogs }, 200, res, "Landing blogs retrieved!")
  } catch (error) {
    console.error("Error:", error)
    return ErrorHandler("Internal server error", 500, res)
  }
...
export default blogControllerWeb;
